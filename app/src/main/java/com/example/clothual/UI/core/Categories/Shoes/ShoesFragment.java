...
public class ShoesFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView.LayoutManager manager = new LinearLayoutManager(requireContext());
            List<Clothual> clothual = model.getShoesList(sharedPreferenceReadWrite.readString(ID));
            List<Image> image = model.getImageShoesList(clothual, sharedPreferenceReadWrite.readString(ID));
