...
public class TShirtFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        List<Clothual> clothual = model.getTShirtList(sharedPreferenceReadWrite.readString(ID));
        List<Image> image = model.getImageTShirtList(clothual, sharedPreferenceReadWrite.readString(ID));
